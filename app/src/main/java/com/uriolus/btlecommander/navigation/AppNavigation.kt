...
import com.uriolus.btlecommander.features.detail.ui.Detail
...
fun AppNavigation() {
    ...
    val devicesViewModel: DevicesListViewModel = getViewModel()
    ...
    NavHost(
        ...
        composable(DEVICES_ROUTE) {
            DevicesListScreen(devicesViewModel, actions.selectedDevice)
        }
        composable(
